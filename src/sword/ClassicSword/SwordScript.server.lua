...
function Blow(Hit)
	...
	if humanoid.Health - Damage <= 0 and not humanoid:GetAttribute("Effect") then
		humanoid:SetAttribute("Effect", true)
		humanoid:TakeDamage(Damage)
		humanoid.BreakJointsOnDeath = false
		character.Archivable = true
		comm:FireAllClients("KillEffect", character, script.Parent.Parent:GetAttribute("Effect") or "default")
		task.defer(function()
